...
#								Widgets
########################################################################
function xiquets_widgets_init() {
	register_sidebar(array(
		'name' => 'Entrada',
		'id'   => 'single',
		'description'   => 'Sidebar per les entrades',
        'before_widget' => '				<li class="timeline-inverted">
        			 <div class="timeline-badge primary"><a><i class="glyphicon glyphicon-record invert" rel="tooltip"></i></a></div>
					<div class="timeline-panel">
						<div class="timeline-body widget">',
        'after_widget' => '        				<br /></div>
        			</div>
	        	</li>',
        'before_title' => '<h4>',
	...
	register_sidebar(array(
		'name' => 'Timeline Esquerre',
		'id'   => 'timeline-esq',
		'description'   => 'Sidebar al Timeline (superior esquerre)',
        'before_widget' => '				<li>
        			 <div class="timeline-badge primary"><a><i class="glyphicon glyphicon-record invert" rel="tooltip"></i></a></div>
					<div class="timeline-panel">
						<div class="timeline-body widget">',
	...
	register_sidebar(array(
		'name' => 'Timeline Dret',
		'id'   => 'timeline-dre',
		'description'   => 'Sidebar al Timeline (superior dret)',
        'before_widget' => '				<li class="timeline-inverted">
        			 <div class="timeline-badge primary"><a><i class="glyphicon glyphicon-record invert" rel="tooltip"></i></a></div>
					<div class="timeline-panel">
						<div class="timeline-body widget">',
	...
	register_sidebar(array(
		'name' => 'Peu de pàgina',
		'id'   => 'footer',
		'description'   => 'Espai al peu de pàgina (footer)',
        'before_widget' => '',
        'after_widget' => '<br />',
        'before_title' => '<p class="text-uppercase"><strong>',
        'after_title' => '</strong></p>'
     ));
}
add_action( 'widgets_init', 'xiquets_widgets_init' );
...
class shareCount {
	...
	function get_tweets() { 
		$json_string = $this->file_get_contents_curl('http://urls.api.twitter.com/1/urls/count.json?url=' . $this->url); //NO VA!!!!!
